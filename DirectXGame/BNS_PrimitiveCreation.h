...
public:
	BNS_AGameObject* CreateCharmander(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreateCubone(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreateEevee(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreateFarfetch(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreateGrowlithe(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreateMachop(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreateNidoranF(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreateNidoranM(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreateOddish(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreatePidgey(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreatePikachu(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreatePalkia(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreatePsyduck(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreateSeel(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreateSquirtle(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreateVulpix(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);

	BNS_AGameObject* CreateJigglypuff(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreateGiratina(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreateCyndaquil(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
	BNS_AGameObject* CreateDialga(Vector3D pos = { 0,0,0 }, Vector3D scale = { 0.05,0.05,0.05 }, bool isAddedToScene = true);
